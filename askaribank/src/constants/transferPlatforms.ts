...
export const TRANSFER_PLATFORMS: TransferPlatform[] = [
  {
    ...
    bgLight: 'bg-blue-50',
    text: 'text-blue-700',
    icon: '/images/platforms/bank.png',
  ...
  },
  {
    ...
    bgLight: 'bg-red-50',
    text: 'text-red-700',
    icon: '/images/platforms/jazzcash.png',
  ...
  },
  {
    ...
    bgLight: 'bg-green-50',
    text: 'text-green-700',
    icon: '/images/platforms/easypaisa.png',
    accountPlaceholder: '03XX XXXXXXX',
    accountPattern: /^03\d{9}$/,
  },
  {
    ...
    icon: '/images/platforms/nayapay.png',
    accountPlaceholder: '03XX XXXXXXX',
    accountPattern: /^03\d{9}$/,
  },
  {
    ...
    icon: '/images/platforms/sadapay.png',
    accountPlaceholder: '03XX XXXXXXX',
    accountPattern: /^03\d{9}$/,
  },
  {
    ...
    icon: '/images/platforms/upaisa.png',
    accountPlaceholder: '03XX XXXXXXX',
    accountPattern: /^03\d{9}$/,
  },
];
